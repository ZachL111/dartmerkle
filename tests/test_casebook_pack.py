"""Regression checks for the dartmerkle casebook."""
...
from casebook.harness import assert_expected, dartmerkle_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(dartmerkle_summary(), assert_expected())
