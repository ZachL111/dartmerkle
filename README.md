...
dartmerkle is a Dart project for algorithms. It focuses on this technical goal: Build Merkle roots and inclusion proof fixtures.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 151, risk penalty 4, latency penalty 3, and weight bonus 2. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
